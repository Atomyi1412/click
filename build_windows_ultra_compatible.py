...
### Basic Features
- **Mouse Auto-Click**: Support single/double click, 1-100 times/second
- **Global Hotkeys**: Ctrl+Alt+S (start), Ctrl+Alt+D (stop)
- **Custom Hotkeys**: Customizable key combinations
- **Settings Save**: Automatically save configurations
...
'''
    ...
    # 复制配置文件
    config_files = ['config_native.json', 'requirements.txt']
